...
df_renamed = df_extracted.rename(
    columns={
        "BUILDING_ID": "Name",
        "BUILDING_HEIGHT": "height_ag",
        "FLOORS": "floors_ag",
        "BUILDING_USE_y": "category",
    }
)
df_renamed["floors_bg"] = 0
df_renamed["height_bg"] = 0
df_ordered = df_renamed[
    [
        "Name",
        "height_ag",
        "height_bg",
...
gdf = gpd.GeoDataFrame(
    df_final, geometry=gpd.points_from_xy(df_final.ITM_EAST, df_final.ITM_NORTH)
)
...
df_cea = points_in_poly[
    ["Name", "height_ag", "height_bg", "floors_ag", "floors_bg", "geometry", "category"]
]
...
df_cea_extracted = df_cea_height[
    ["Name", "height_ag", "height_bg", "floors_ag", "floors_bg", "geometry", "category"]
]
...
surroundings_ordered = surroundings[
